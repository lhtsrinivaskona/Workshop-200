...
$opt_name = 'redux'; // Change this value to the option name, you can find this in functions.php e.g. $gp = get_option( 'option_name' );
$section = array(
    'title'  => __('General', 'whiteblogs'),
    'id'     => 'general',
    'desc'   => '',
    'icon'   => 'fa fa-home',
    'fields' => array(
...
Redux::setSection( $opt_name, array(
        'title' => __('Menu', 'whiteblogs'),
        'id'    => 'menu',
        'icon'  => 'fa fa-bars'
    ) );
$sections = array(
    'title'  => __('Mobile Menu', 'whiteblogs'),
    'id'     => 'mobile-menu',
    'icon'  => 'fa fa-mobile',
    'subsection' => true,
    'fields' => array(
...
$sections = array(
    'title'  => __('Desktop Menu', 'whiteblogs'),
    'id'     => 'desktop-menu',
    'icon'  => 'fa fa-desktop',
    'subsection' => true,
    'fields' => array(
